...
runtime_eig = runtime_eig + toc;
end
runtime_eig = runtime_eig / n_rng;
ii=0;
...
fprintf('time eigs+ac');
for ii=1:length(ratio_known_array); fprintf(' | %4.2f', runtime_eig+mean_runtimes(ii)); end; fprintf('\n');
end
